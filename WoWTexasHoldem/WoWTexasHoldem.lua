...
-- 4.1.5
-- Changed TOC to 90001
-- Changes for 90000 API (setbackdrop).
...
local FHS_HOLDEM_version             = "v4.1.4";
...
function FHS_SetupDealerButtonsFrame()
	...
	buttonsFrame:Hide();
	buttonsFrame:SetHeight(40);buttonsFrame:SetWidth(280);
...
function FHS_SetupStatusFrame()
	...
	statusFrame:SetPoint("CENTER",FHSPokerFrame,"CENTER",0,-110);
